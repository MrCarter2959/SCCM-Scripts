...
$AppArrayList += Get-AppxPackage -AllUsers | Where {$_.Name -like "*SpeedTest*"} | Select-Object -Property Name, PackageFullName
$AppArrayList += Get-AppxPackage -AllUsers | Where {$_.Name -like "*whiteboard*"} | Select-Object -Property Name, PackageFullName
$AppArrayList += Get-AppxPackage -AllUsers | Where {$_.Name -like "*xbox*"} | Select-Object -Property Name, PackageFullName
$AppArrayList += Get-AppxPackage -AllUsers | Where {$_.Name -like "*skype*"} | Select-Object -Property Name, PackageFullName
